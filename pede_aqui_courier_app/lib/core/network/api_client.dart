...
class ApiClient {
  ...
  static const String _defaultBaseUrl = String.fromEnvironment('API_BASE_URL', defaultValue: 'http://10.0.2.2:8080/api/v1');
  ...
  static const String keycloakIssuer = String.fromEnvironment('KEYCLOAK_ISSUER', defaultValue: 'http://localhost:8080/realms/delivery');
  static const String keycloakTokenEndpoint = '$keycloakIssuer/protocol/openid-connect/token';
