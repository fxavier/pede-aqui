...
import { Plus, Edit, Trash2, Tag, GitBranch } from 'lucide-react';
...
export default function AdminCategoriesPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      setError('Erro ao eliminar categoria. Verifique se não tem produtos ou subcategorias associadas.');
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="mt-1 text-body-md text-on-surface-variant">
              Administrar todas as categorias de produtos organizadas hierarquicamente
            </p>
          </div>
          <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Preencha os campos abaixo para criar uma nova categoria de produto no sistema.
                </DialogDescription>
              </DialogHeader>
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Modifique os campos desejados para atualizar a categoria no sistema.
              </DialogDescription>
            </DialogHeader>
