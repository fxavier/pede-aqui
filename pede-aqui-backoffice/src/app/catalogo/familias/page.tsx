...
export default function ProductFamiliesPage() {
  ...
  const loadVariationGroups = async () => {
    ...
    try {
      ...
      console.error('Erro ao carregar grupos de variação:', error);
    }
  };
  ...
  const loadOptions = async () => {
    ...
    try {
      ...
      console.error('Erro ao carregar opções de variação:', error);
    }
  };
  ...
  const handleEditGroup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Erro ao editar grupo de variação:', error);
    }
  };
  ...
  const handleDeleteGroup = async (id: string) => {
    ...
    try {
      ...
      console.error('Erro ao eliminar grupo de variação:', error);
    }
  };
  ...
  const handleEditOption = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Erro ao editar opção de variação:', error);
    }
  };
  ...
  const handleDeleteOption = async (id: string) => {
    ...
    try {
      ...
      console.error('Erro ao eliminar opção de variação:', error);
    }
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerir grupos de variações e opções para produtos
          </p>
        </div>
        {selectedProduct && (
                ...
                <Dialog open={createGroupDialogOpen} onOpenChange={setCreateGroupDialogOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Configure uma nova família de produtos com suas regras de seleção.
                      </DialogDescription>
                    </DialogHeader>
                  ...
                  <Dialog open={createOptionDialogOpen} onOpenChange={setCreateOptionDialogOpen}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Adicione uma nova opção a esta família de produtos.
                        </DialogDescription>
                      </DialogHeader>
      ...
      <Dialog open={editGroupDialogOpen} onOpenChange={setEditGroupDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Modifique as configurações desta família de produtos.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={editOptionDialogOpen} onOpenChange={setEditOptionDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Modifique os detalhes desta opção de produto.
            </DialogDescription>
          </DialogHeader>
